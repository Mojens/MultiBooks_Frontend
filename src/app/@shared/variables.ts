export class Variables {
  ...
  static accountOptions = [
    ...
    {
      label: '1100 - EU deliveries of goods - Reported (box B goods)',
      value: '1100 - EU deliveries of goods - Reported (box B goods)'
    },
    {
      label: '1150 - EU deliveries of goods - Not reported (box B goods)',
      value: '1150 - EU deliveries of goods - Not reported (box B goods)'
    },
    {
      label: '1200 - EU deliveries of services (box B services)',
      value: '1200 - EU deliveries of services (box B services)'
    },
    {
      label: '1255 - Sale of goods to foreign countries (box C)',
      value: '1255 - Sale of goods to foreign countries (box C)'
    },
    {
      label: '1260 - Sale of services to foreign countries (box C)',
      value: '1260 - Sale of services to foreign countries (box C)'
    },
    ...
    {
      label: '1400 - Reminder fees, administration fees, etc.',
      value: '1400 - Reminder fees, administration fees, etc.'
    },
  ...
  static accountOptionsForRecords = [
    {
      ...
      items: [
        ...
        {
          label: 'EU acquisitions of services (Category A services)',
          value: 'EU acquisitions of services (Category A services)'
        },
    ...
    },
    {
      ...
      items: [
        ...
        {
          label: 'Meals during courses/meetings, fully deductible',
          value: 'Meals during courses/meetings, fully deductible'
        },
        ...
        {
          label: 'Miscellaneous regarding employees without VAT',
          value: 'Miscellaneous regarding employees without VAT'
        },
    ...
    },
    {
      ...
      items: [
        ...
        {
          label: 'Hotel, business contacts, partially deductible',
          value: 'Hotel, business contacts, partially deductible'
        },
        {label: 'Conferences', value: 'Conferences'},
        {label: 'Trade fairs', value: 'Trade fairs'},
        {
          label: 'Entertainment, restaurant, personnel, fully deductible',
          value: 'Entertainment, restaurant, personnel, fully deductible'
        },
        {
          label: 'Entertainment, restaurant, business contacts, partially deductible',
          value: 'Entertainment, restaurant, business contacts, partially deductible'
        },
        {
          label: 'Meals in the company for business contacts, partially deductible',
          value: 'Meals in the company for business contacts, partially deductible'
        },
        {
          label: 'Entertainment, gifts, and flowers, partially deductible',
          value: 'Entertainment, gifts, and flowers, partially deductible'
        },
    ...
    },
    {
      ...
      items: [
        ...
        {
          label: 'General meetings, board meetings outside the city, fully deductible',
          value: 'General meetings, board meetings outside the city, fully deductible'
        },
